...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>PRODUCT - SUPPERCLEAN</title>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="product-details-content pro-details-content-mrg">
                                ...
                                <div class="pro-details-quality">
                                    <span>Quantity:</span>
                                    <div th:if="${requestScope.productData.productQuantity > 0}" class="cart-plus-minus">
                                    ...
                                    <c:if test="${requestScope.ProductData.productQuantity == 0}">
                                        <div class="quality">
