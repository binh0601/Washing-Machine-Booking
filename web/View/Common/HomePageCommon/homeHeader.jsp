                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="header-offer-wrap-4 text-center">
                            <p><span class="uppercase">Free shipping</span> worldwide for orders over <span class="amount">199$.</span> <a href="#"></a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-5">
                    <div class="mobile-logo">
                        <a href="Home">
                            <img alt="" style="width:40%" src="${pageContext.request.contextPath}/assets/images/logo/clothing.jpg">
                        </a>
                    </div>
                </div>
                <div class="col-7">
